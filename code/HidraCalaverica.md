...
title: HadesTheWiki - Hidra Calaverica
description: Página de Hidra Calaverica de HadesTheWiki
---
...
<section class="row">
        <article class="col-12 col-md-4">
          <p class="text-center">La Hidra Calavérica es el remanente de la legendaria Hidra de Lerna, una formidable bestia derrotada por el semidiós Heracles como parte de sus doce trabajos. Ahora, este ser habita en el Flegetonte, el río abrasador que atraviesa los Asfódelos, custodiando la entrada al Elíseo.</p>
          <p class="text-center">El enfrentamiento con la Hidra Calavérica representa el combate final en los Asfódelos y es el segundo jefe del juego. Siempre se encontrará en la cámara número 24, la última cámara de los Asfódelos.</p>
        </article>
        <article class="col-12 col-md-4">
          <aside><img width="100%" height="auto" src="/img/HidraBase.webp" class="img-fluid" alt=""></aside>
        </article>
        <article class="col-12 col-md-4">
          <table class="table">
            <thead>
            ...
            <tbody class="table-group-divider">
              ...
              <tr>
                <td>Salud</td>
                <td>
                <li>5940 (Hidra principal)</li>
                <li>820 (410 de blindaje, 410 de salud) (Hidras de apoyo)</li>
                </td>
              </tr>
            </tbody>
          </table>
...
<hr>
<h2 class="text-center">Combate</h2>
<p>Enfrentarás a la Hidra Calavérica en un escenario especialmente diseñado para el combate contra ella. Este escenario tiene una forma semihexagonal y consiste en una isla rodeada de magma. En las esquinas superiores de la isla, encontrarás dos vasijas que contienen salud para recuperarte, mientras que en el centro hay cuatro pilares indestructibles. La hidra emergirá desde la parte central superior y, con sus ataques, avanzará hacia el centro de la isla.
...
NOTA: Los efectos de daño en el tiempo aplicados antes de que la Hidra se volviera invulnerable no causarán daño una vez que se vuelva invulnerable entre rondas.</p>
<hr>
<h3 class="text-center">Variantes de la Hidra</h3>
<section class="row">
<article class="col-12 col-md-6">
<img width="50%" height="auto" src="/img/HidraBlancoAzul.webp" class="img-fluid rounded mx-auto d-block" alt="HidraBlancoAzul">
</article>
<article class="col-12 col-md-6">
<p>
...
- Después de ser reducida al 66% de su salud máxima, adquiere la habilidad adicional de lanzar de 8 a 11 bolas de fuego en un círculo alrededor de sí misma (en lugar de Barrage). A diferencia de Barrage, esta habilidad no se pierde mientras las Cabezas de Apoyo estén activas..</p>
</article>
</section>
<hr>
<section class="row">
<article class="col-12 col-md-6">
<img width="50%" height="auto" src="/img/HidraCalavericaVerde.webp" class="img-fluid rounded mx-auto d-block" alt="HidraVerde">
</article>
<article class="col-12 col-md-6">
<p>
...
- Cuando alcanza el 33% de su salud máxima, puede escupir 3 orbes a la vez cuando las Cabezas de Apoyo estén inactivas. También puede invocar tres Machacacráneos en sucesión.</p>
</article>
</section>
<hr>
<section class="row">
<article class="col-12 col-md-6">
<img width="50%" height="auto" src="/img/HidraMorada.webp" class="img-fluid rounded mx-auto d-block" alt="HidraMorada">
</article>
<article class="col-12 col-md-6">
<p>
...
<article class="col-12 col-md-6">
<p>… Despojada de la carne que el héroe Heracles le arrancó y cauterizó, la Hidra habita ahora en el Inframundo, donde se cuece a fuego lento junto al tumultuoso río de fuego que llamamos Flegetonte. Vigila sin descanso ni piedad el pasaje que conduce al Elíseo, devorando a aquellas sombras que osan buscar consuelo en ese paradisíaco lugar.</p>
</article>
</section>